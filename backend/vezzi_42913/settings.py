"""
Django settings for vezzi_42913 project.
...
WSGI_APPLICATION = 'vezzi_42913.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vezzi_42913 API",
    "DESCRIPTION": "API documentation for vezzi_42913 App",
    "VERSION": "v1",
}
